...
export default function ProductCard({ id, name, refNo, description, image, category }: ProductCardProps) {
  return (
    <div className="product-card group flex flex-col h-full">
      {/* Image */}
      <div className="bg-industrial-grey overflow-hidden" style={{ aspectRatio: "4/3" }}>
        <img
          src={image}
          alt={name}
      ...
      <div className="bg-navy px-4 py-2.5">
        <div className="flex items-center justify-between">
          <h3 className="text-white font-body font-bold text-sm uppercase tracking-wide truncate">{name}</h3>
