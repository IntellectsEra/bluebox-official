...
import { Phone, Mail, MapPin, Plus, Trash2, CheckCircle, MessageCircle } from "lucide-react";
...
export default function Contact() {
  ...
  const updateRow = (i: number, field: keyof ProductRow, value: string) => {
    setProductRows(
      productRows.map((r, idx) => (idx === i ? { ...r, [field]: value } : r)),
    );
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-navy py-16 relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "repeating-linear-gradient(0deg, transparent, transparent 39px, rgba(200,169,106,0.5) 40px), repeating-linear-gradient(90deg, transparent, transparent 39px, rgba(200,169,106,0.5) 40px)",
          }}
        />
            ...
            <div className="lg:col-span-2 animate-slide-up">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 p-4 border border-border-subtle shadow-card">
                  ...
                  <div>
                    <div className="font-body font-bold uppercase tracking-widest text-[10px] text-navy mb-1">
                      Office Address
                    </div>
                ...
                <div className="flex items-center gap-4 p-4 border border-border-subtle shadow-card">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="font-body text-sm text-foreground/70 hover:text-gold transition-colors"
                    >
                      +91 98844 11134
                    </a>
                  </div>
              ...
              {submitted ? (
                <div className="border-2 border-gold bg-white p-12 text-center shadow-hard-gold">
                  ...
                  <p className="font-body text-foreground/65 text-base leading-relaxed">
                    Thank you! Our team will contact you shortly to discuss your
                    requirements.
                  </p>
                  <button
                ...
                <form
                  ...
                  noValidate
                  className="border border-border-subtle bg-white shadow-hard"
                >
                  ...
                  <div className="p-6 space-y-5">
                    ...
                    <div>
                      <label className="form-label">
                        Products & Minimum Order Quantity
                      </label>
                          ...
                          <div key={i} className="flex gap-2 items-start">
                            ...
                            <div className="w-28 shrink-0">
                              <input
                                ...
                                value={row.moq}
                                onChange={(e) =>
                                  updateRow(i, "moq", e.target.value)
                                }
                                min="1"
                              />
                            </div>
