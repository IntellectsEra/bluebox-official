...
export const CATEGORIES_MAIN = [
  { value: "all", label: "All Products" },
  { value: "hinges", label: "SS Hinges (Premium / Welded)" },
  { value: "door-handles", label: "Door Handles" },
  { value: "door-chain", label: "Door Chain" },
  { value: "door-stoppers", label: "Door Stoppers" },
  { value: "aldrops", label: "Aldrops" },
  { value: "tower-bolts", label: "Tower Bolts" },
  { value: "mortise-lock", label: "Mortise Locks" },
  { value: "cabinet-handles", label: "Cabinet Handles" },
  { value: "knobs", label: "Knobs" },
  { value: "sofa-legs", label: "Sofa Legs" },
  { value: "castor-wheels", label: "Castor Wheels" },
  { value: "ss-kitchen-baskets", label: "SS Kitchen Baskets" },
  { value: "other", label: "Others" },
];
